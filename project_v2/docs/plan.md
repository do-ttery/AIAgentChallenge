...
핵심 화면 3개를 순수 HTML/CSS로 만든 프로토타입 (JS 없음, 화면 구조 확인용).

- ▶ **[프로토타입 열어보기 (prototype.html)](prototype.html)** — QR 랜딩 · 진행 중 · 사장님 대시보드
- 디자인은 `laundry-design` 스킬 규칙을 따름 (색 토큰·예측 범위 표기·자동/개입 색 구분 등)
